...
func (x *StreamPoint) GetBuffer() []byte {
	if x != nil {
		return x.Buffer
	}
	return nil
...
func (x *StreamResponse) GetN() string {
	if x != nil {
		return x.N
	}
	return ""
...
var file_test_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x4f, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x50, 0x6f, 0x69,
	...
	0x66, 0x66, 0x65, 0x72, 0x22, 0x33, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	...
	0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x02, 0x70, 0x74, 0x22, 0x1e, 0x0a, 0x0e, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0c, 0x0a, 0x01, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x6e, 0x32, 0xbf, 0x01, 0x0a, 0x0d, 0x53, 0x74,
...
var file_test_proto_depIdxs = []int32{
	...
	1, // 1: proto.StreamService.List:input_type -> proto.StreamRequest
	1, // 2: proto.StreamService.Record:input_type -> proto.StreamRequest
	1, // 3: proto.StreamService.Route:input_type -> proto.StreamRequest
	2, // 4: proto.StreamService.List:output_type -> proto.StreamResponse
	2, // 5: proto.StreamService.Record:output_type -> proto.StreamResponse
	2, // 6: proto.StreamService.Route:output_type -> proto.StreamResponse
